...
labelfile = "/Users/nolwenbrosson/Desktop/Cours Nolwen/Cours Centrale/Hackaton/data/predictors_bitcoin.xlsx"
predictors_bitcoin = pd.read_excel(labelfile)
predictors_bitcoin = predictors_bitcoin["change"]
predictors_bitcoin.columns = range(0,1)
predictors_bitcoin = predictors_bitcoin.loc[0:364]




predictors_bitcoin = predictors_bitcoin.apply(pd.to_numeric)
    
final_dataset = final_dataset.as_matrix()
predictors_bitcoin = predictors_bitcoin.as_matrix()

# Model part: Simple Linear Regression



reg = LinearRegression().fit(final_dataset, predictors_bitcoin)
reg.score(final_dataset, predictors_bitcoin)
